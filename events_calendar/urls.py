...
from events.views import download_selected_images, delete_selected_images
...
urlpatterns = [
    ...
    path("events/<int:event_id>/delete-selected/", delete_selected_images, name='delete_event_images'),
